...
const Academics = ({ onCourseSelect, onProgramSelect }) => {
  ...
  const courseList = [
    ...
    },
    {
      ...
      description: "Advanced algorithmic techniques and complexity analysis for complex problem solving.",
      status: "Available",
      image: "⚡",
      degree: "MSc CSE",
      semester: "2nd"
    ...
    },
    {
      ...
      description: "Principles of computer graphics, 2D/3D transformations, and rendering techniques.",
      status: "Available",
      image: "🎨",
      degree: "BSc CSE",
      semester: "3rd"
    },
    {
      ...
      description: "Research methods, thesis writing, and academic publication guidelines.",
      status: "Available",
      image: "📝",
      degree: "MSc CSE",
      semester: "1st"
    },
    {
      ...
      description: "Advanced programming concepts using object-oriented paradigms and design patterns.",
      status: "Available",
      image: "🔧",
      degree: "BSc CSE",
      semester: "2nd"
    },
    {
      ...
      description: "Computer system design, processor architecture, and performance optimization.",
      status: "Available",
      image: "⚙️",
      degree: "BSc CSE",
      semester: "4th"
    },
    {
      ...
      description: "Deep learning, neural networks, and advanced AI techniques.",
      status: "Available",
      image: "🧠",
      degree: "MSc CSE",
      semester: "2nd"
    },
    {
      ...
      description: "Modern web development, frameworks, and full-stack programming.",
      status: "Available",
      image: "🌍",
      degree: "BSc CSE",
      semester: "3rd"
    },
    {
      ...
      code: "CSE505",
      title: "Thesis",
      description: "Independent research project and thesis preparation.",
      status: "Available",
      image: "📚",
      degree: "MSc CSE",
      semester: "3rd"
    ...
    },
    {
      ...
      description: "Lexical analysis, syntax analysis, semantic analysis, and code generation.",
      status: "Available",
      image: "⚙️",
      degree: "BSc CSE",
      semester: "5th"
    ...
    },
    {
      ...
      description: "Android and iOS development, cross-platform frameworks, and mobile UI/UX.",
      status: "Available",
      image: "📱",
      degree: "BSc CSE",
      semester: "7th"
    },
    {
      ...
      description: "Distributed computing, consensus algorithms, fault tolerance, and scalability.",
      status: "Available",
      image: "🌐",
      degree: "BSc CSE",
      semester: "7th"
    },
    {
      ...
      code: "CSE801",
      title: "Project Work",
      description: "Capstone project involving design, implementation, and documentation.",
      status: "Available",
      image: "🚀",
      degree: "BSc CSE",
      semester: "8th"
    ...
    },
    {
      ...
      description: "User interface design, usability testing, and interaction design principles.",
      status: "Available",
      image: "👆",
      degree: "BSc CSE",
      semester: "6th"
    },
    {
      ...
      description: "Image enhancement, filtering, feature extraction, and computer vision basics.",
      status: "Available",
      image: "🖼️",
      degree: "BSc CSE",
      semester: "6th"
  ...
  const renderDegreeOutlines = () => (
    <div className="content-section" id="degree-outlines-section">
  ...
  const renderCourseList = () => {
    ...
    return (
      <div className="content-section" id="course-list-section">
