...
def create_overview(overview: OverviewCreate, db: get_db_session, current_user: get_current_user):
...
def update_overview(overview_id: int, overview: OverviewUpdate, db: get_db_session, current_user: get_current_user):
...
def get_announcement_types(db: get_db_session, skip: int = 0, limit: int = 100):
...
def get_announcement_type(type_id: int, db: get_db_session):
...
def create_announcement_type(announcement_type: AnnouncementTypeCreate, db: get_db_session, current_user: get_current_user):
...
def update_announcement_type(type_id: int, announcement_type: AnnouncementTypeUpdate, db: get_db_session, current_user: get_current_user):
...
def get_announcements(db: get_db_session, skip: int = 0, limit: int = 10):
...
def get_announcement(announcement_id: int, db: get_db_session):
...
def create_announcement(announcement: AnnouncementCreate, db: get_db_session, current_user: get_current_user):
...
def update_announcement(announcement_id: int, announcement: AnnouncementUpdate, db: get_db_session, current_user: get_current_user):
...
def get_quicklinks(db: get_db_session, skip: int = 0, limit: int = 10):
...
def get_quicklink(quicklink_id: int, db: get_db_session):
...
def create_quicklink(quicklink: QuickLinkCreate, db: get_db_session, current_user: get_current_user):
...
def update_quicklink(quicklink_id: int, quicklink: QuickLinkUpdate, db: get_db_session, current_user: get_current_user):
