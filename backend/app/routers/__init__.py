...
from routers import token, auth, img, profile, homepage, faculty, notice, classroom, committee, committee_member, research_assistant, equipment, equipment_booking, office_room, room_booking
router = APIRouter(
    prefix="/api/v1"
)
...
router.include_router(room_booking.router)
